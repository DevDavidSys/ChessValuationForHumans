...
def classify_games(input_file, output_file):
    ...
    return output_file  # Retorna o caminho do arquivo de saída
...
output_file = get_output_file_path()  # Caminho gerado para o arquivo de saída

# Classificar os jogos e obter o caminho do arquivo de saída
classified_file_path = classify_games(input_file, output_file)
print(f"Arquivo salvo em: {classified_file_path}")
